...
START TRANSACTION;
USE `payicam_reservation_sandwichs`;
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (1, 'Sandwich classique demi', 498, DEFAULT, 0, 0, 0);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (2, 'Menu classique demi', 493, DEFAULT, 0, 0, 0);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (3, 'Sandwich spécial demi', 1039, DEFAULT, 0, 1, 1);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (4, 'Menu spécial demi', 1051, DEFAULT, 0, 1, 1);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (5, 'Sandwich classique baguette', 1050, DEFAULT, 0, 0, 1);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (6, 'Menu classique baguette 	', 1053, DEFAULT, 0, 0, 1);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (7, 'Sandwich spécial baguette', 1049, DEFAULT, 0, 1, 1);
INSERT INTO `payicam_reservation_sandwichs`.`purchases_possibilities` (`possibility_id`, `name`, `article_id`, `description`, `is_removed`, `is_special`, `closure_type`) VALUES (8, 'Menu spécial baguette', 1052, DEFAULT, 0, 1, 1);
